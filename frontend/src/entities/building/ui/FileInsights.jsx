                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {insights.map((insight, i) => (
                        <div key={i} style={{
                            ...
                            // borderLeft: `2px solid ${getColorForType(insight.type)}`, // Too loud
                            borderRadius: '0px',
                            padding: '16px',
                            display: 'flex',
                            gap: '16px',
                            ...
                            <div>
                                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: '#e4e4e7', marginBottom: '6px', letterSpacing: '0.02em' }}>
                                    {insight.title}
                                </div>
                                <div style={{ fontSize: '0.8rem', color: '#a1a1aa', lineHeight: '1.6', fontFamily: 'var(--font-sans)' }}>
                                    {insight.description}
                                </div>
                            </div>
                        </div>
