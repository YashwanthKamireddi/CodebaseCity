...
export class PhysicsEngine {
     ...
     */
    get_matrices_ptr() {
        const ret = wasm.physicsengine_get_matrices_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} count
     */
    constructor(count) {
        const ret = wasm.physicsengine_new(count);
     ...
     * @param {number} sz
     */
    set_building(i, x, y, z, sx, sy, sz) {
        wasm.physicsengine_set_building(this.__wbg_ptr, i, x, y, z, sx, sy, sz);
    }
    /**
     * @param {number} dt
     * @param {number} time
     */
    tick(dt, time) {
        wasm.physicsengine_tick(this.__wbg_ptr, dt, time);
    }
}
